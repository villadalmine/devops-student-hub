...
datas = [
    ...
    ('curso.json', '.'),
    ('README.md', '.'),
    ('01-Guia-Completa-Instalacion-Windows.md', '.'),
    ('01-Instalacion-Software-y-Diagnostico.md', '.'),
    ('02-Guia-Instalacion-Linux.md', '.'),
    ('03-Guia-Instalacion-MacOS.md', '.'),
    ('04-Guia-Linux-en-Windows-WSL2-Grafica.md', '.'),
    ('scripts', 'scripts'),
    ('material', 'material'),
    ('apuntes', 'apuntes'),
    ('practicas', 'practicas'),
